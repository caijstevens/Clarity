<frame>
    <page>
        ...
        <absoluteLayout top="30" height="30">
            <label class="currentColourDisplay" width="50" horizontalAlignment="center" text="P" color="{utils.getTextColourFromBackground(thisUser.profileColour)}"/>
        </absoluteLayout>
...
<script lang="ts">
    ...
    function applyColour(newColour: string) {
        thisUser.onProfileColourChanged(newColour);
        forceUpdate();
    }
